...
<link href="https://cdn.jsdelivr.net/npm/sweetalert2@11.12.4/dist/sweetalert2.min.css" rel="stylesheet">
   ...
   <div class="container m-2" style="display: flex; justify-content: center; align-items: center; " >
        <a href="{{ route('banner.create') }}" class="btn btn-primary my-3 col-6 ">Add Banner<i class="fa-solid fa-plus"></i></a>
    ...
    <table class="table table-white table-hover">
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td><img src="{{ $item->banner_pic }}" height="100" width="150" alt="/img/no_img.jpg">




                 <td><a href="{{route('banner.edit', $item->_id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                <form action="{{ route('banner.destroy', $item->_id)}}" class="d-inline" onsubmit="confirmDelete(event)"
                    method="POST">
                @csrf
                @method('delete')    
